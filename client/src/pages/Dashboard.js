  ...
  const getRoleSpecificContent = () => {
    if (user?.role === "patient") {
      return {
        ...
        description:
          "Track your appointments, diagnoses, and medicine reminders.",
        quickActions: [
      ...
      return {
        ...
        description:
          "Manage your appointments, patient diagnoses, and schedule.",
        quickActions: [
      ...
      return {
        ...
        description:
          "Monitor system statistics and manage hospital operations.",
        quickActions: [
